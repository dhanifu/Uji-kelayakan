...
<div class="content-wrapper">
	<div class="row">
		<div class="col-sm-12 mb-4 mb-xl-0">
			...
			<p class="font-weight-normal mb-2 text-muted"><?= $bulan[date('m')].' '.date('d').', '.date('Y') ?></p>
		</div>
	</div>
		...
		<div class="col-xl-4 flex-column d-flex grid-margin stretch-card">
			<div class="row flex-grow">
				<div class="col-sm-12 grid-margin stretch-card">
					<div class="card" style="border-radius: 6px" style="border-radius: 6px">
						<a href="/masterdayas" class="btn btn-outline-danger btn-fw">
							<div class="card-body">
								<h1 class="display-5 text-dark font-weight-bold">Master Daya</h1>
							</div>
						</a>
					</div>
				</div>
			...
			<div class="row flex-grow">
				<div class="col-sm-12 grid-margin stretch-card">
					<div class="card" style="border-radius: 6px">
						<a href="/users" class="btn btn-outline-primary btn-fw">
							<div class="card-body">
								<h1 class="display-5 text-dark font-weight-bold">User</h1>
							</div>
						</a>
					</div>
				</div>
	...
	<div class="row">
		...
		<div class="col-xl-4 flex-column d-flex grid-margin stretch-card">
			<div class="row flex-grow">
				<div class="col-sm-12 grid-margin stretch-card">
					<div class="card" style="border-radius: 6px">
						<a href="/pelanggans" class="btn btn-outline-info btn-fw">
							<div class="card-body">
								<h1 class="display-5 text-dark font-weight-bold">Pelanggan</h1>
							</div>
						</a>
					</div>
				</div>
	...
	<div class="row">
		...
		<div class="col-xl-4 flex-column d-flex grid-margin stretch-card">
			<div class="row flex-grow">
				<div class="col-sm-12 grid-margin stretch-card">
					<div class="card" style="border-radius: 6px">
						<a href="/laporans" class="btn btn-outline-light btn-fw">
							<div class="card-body">
								<h1 class="display-5 text-dark font-weight-bold">Laporan Transaksi</h1>
							</div>
						</a>
					</div>
				</div>
	...
	<div class="row">
		<div class="col-xl-4 flex-column d-flex grid-margin stretch-card">
			<div class="row flex-grow">
				<div class="col-sm-12 grid-margin stretch-card">
					<div class="card" style="border-radius: 6px">
						<a href="/pakets" class="btn btn-outline-warning btn-fw">
							<div class="card-body">
								<h1 class="display-5 text-dark font-weight-bold">Paket/tagihan</h1>
							</div>
						</a>
					</div>
				</div>
		...
		<div class="col-xl-4 flex-column d-flex grid-margin stretch-card">
			<div class="row flex-grow">
				<div class="col-sm-12 grid-margin stretch-card">
					<div class="card" style="border-radius: 6px">
						<a href="/transaksis" class="btn btn-outline-success btn-fw">
							<div class="card-body">
								<h1 class="display-5 text-dark font-weight-bold">Transaksi</h1>
							</div>
						</a>
					</div>
				</div>
